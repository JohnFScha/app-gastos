...
function App() {
  ...
  return (
    <main className='min-h-screen flex flex-col justify-center items-center gap-5 p-5'>
      <h1 className='text-2xl xl:text-6xl font-[900] stroke-2 border-2 container text-center p-5 hover:bg-slate-900 transition duration-200 rounded-xl'>Calculadora de {easterEgg ? 'loquis' : 'gastos'}</h1>
      ...
      <>
        {easterEgg && (<button type="button" className='btn btn-circle btn-accent fixed bottom-[2%] xl:top-[5%] right-[1%] size-[60px]' onClick={() => audioPlayer(audioRef)}>
